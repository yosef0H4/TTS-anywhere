...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    serve.add_argument("--detect-device", default="auto", choices=["auto", "cpu", "gpu"], help="Execution device for detect endpoint")
    serve.add_argument("--ocr-device", default="auto", choices=["auto", "cpu", "gpu"], help="Execution device for OpenAI OCR endpoint")
