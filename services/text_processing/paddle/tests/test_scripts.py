...
@pytest.mark.parametrize(
    ("script_name", "expected_env"),
    [
        ("host_both.bat", ".venv-cpu"),
        ("host_both_gpu.bat", ".venv-gpu"),
        ("host_both_cpu_ocr_gpu.bat", ".venv-gpu"),
        ("host_both_gpu_ocr_cpu.bat", ".venv-gpu"),
    ],
)
def test_batch_scripts_dry_run_uses_bundled_uv(script_name: str, expected_env: str, tmp_path: Path) -> None:
