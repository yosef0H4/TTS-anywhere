...
export const DEFAULT_CONFIG: AppConfig = {
  ...
  system: {
    ...
    autoReaderHotkey: "ctrl+shift+alt+r",
    autoReaderAdvanceHotkey: "space",
    autoReaderAdvanceDelayMs: 900,
    autoReaderNoTextRetryCount: 5,
    clipboardWatcherEnabled: false,
    clipboardWatcherHotkey: "ctrl+shift+alt+v",
    ...
    feedbackSounds: {
      byHotkey: {
        ...
        autoReader: { soundId: "replay_capture_echo", volume: 10 },
        clipboardWatcher: { soundId: "copy_play_confirm", volume: 10 },
