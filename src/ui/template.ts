  ...
  <div id="app-shell">
    ...
    <aside class="settings-drawer" id="settings-drawer" aria-hidden="true">
      ...
      <div class="settings-layout" id="settings-layout">
        ...
        <section class="setting-section" data-section="ocr">
          ...
          <div class="setting-group"><label>Max Tokens</label><input type="number" id="llm-max-tokens" min="1"></div>
    ...
    <div class="main-content">
      <div class="top-actions">
        ...
        <button id="btn-extract" class="icon-pill" title="Extract OCR"><i data-lucide="scan-text" class="ui-icon"></i></button>
