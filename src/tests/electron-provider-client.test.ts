...
function createApi(overrides: Partial<ElectronApi> = {}): ElectronApi {
  return {
    ...
    onClipboardWatcherItem: () => undefined,
    onClipboardWatcherStateChanged: () => undefined,
    ...
    getCopyHotkey: async () => "",
    beginAutoReaderHotkeyEdit: async () => "",
    applyAutoReaderHotkey: async () => "",
    clearAutoReaderHotkey: async () => "",
    cancelAutoReaderHotkeyEdit: async () => "",
    getAutoReaderHotkey: async () => "",
    beginClipboardWatcherHotkeyEdit: async () => "",
    applyClipboardWatcherHotkey: async () => "",
    clearClipboardWatcherHotkey: async () => "",
    cancelClipboardWatcherHotkeyEdit: async () => "",
    getClipboardWatcherHotkey: async () => "",
    ...
    setAutoReaderSettings: async (settings) => settings,
    getClipboardWatcherEnabled: async () => false,
    setClipboardWatcherEnabled: async () => false,
    reportAutoReaderPageResult: async () => undefined,
